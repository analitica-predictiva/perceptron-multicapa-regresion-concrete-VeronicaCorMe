...
def pregunta_04():
    ...
    #   * De 1 a 8 neuronas en la capa oculta ok
    #   * Activación con la función `relu`. ok
    #   * Tasa de aprendizaje adaptativa0k
    #   * Momentun con valores de 0.7, 0.8 y 0.9  ok
    #   * Tasa de aprendizaje inicial de 0.01, 0.05, 0.1 ok
    #   * Un máximo de 5000 iteraciones ok
    #   * Use parada temprana ok
    ...
    #  * Validación cruzada con 5 particiones ok
    #  * Compare modelos usando r^2 ok
